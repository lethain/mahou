@STATIC;1.0;p;15;_CPCibLoading.jI;21;Foundation/CPBundle.jI;25;Foundation/CPDictionary.jI;21;Foundation/CPString.jc;1994;
...
p;18;_CPCibObjectData.jI;20;Foundation/CPArray.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jc;5123;
{var the_class = objj_allocateClassPair(CPObject, "_CPCibObjectData"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_namesKeys"), new objj_ivar("_namesValues"), new objj_ivar("_accessibilityConnectors"), new objj_ivar("_accessibilityOidsKeys"), new objj_ivar("_accessibilityOidsValues"), new objj_ivar("_classesKeys"), new objj_ivar("_classesValues"), new objj_ivar("_connections"), new objj_ivar("_fontManager"), new objj_ivar("_framework"), new objj_ivar("_nextOid"), new objj_ivar("_objectsKeys"), new objj_ivar("_objectsValues"), new objj_ivar("_oidKeys"), new objj_ivar("_oidValues"), new objj_ivar("_rootObject"), new objj_ivar("_visibleWindows")]);
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        _rootObject = objj_msgSend(aCoder, "decodeObjectForKey:", _CPCibObjectDataRootObjectKey);
    }
    return self;
}
});
...
{ with(self)
{
    ...
    objj_msgSend(aCoder, "encodeObject:forKey:", _rootObject, _CPCibObjectDataRootObjectKey);
}
});
class_addMethods(the_class, instance_methods);
}
...
p;15;_CPWindowView.ji;8;CPView.ji;13;CPImageView.jc;11584;
var _CPWindowViewResizeIndicatorImage = nil;
{var the_class = objj_allocateClassPair(CPView, "_CPWindowView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_styleMask"), new objj_ivar("_resizeIndicator"), new objj_ivar("_title")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
var class_methods = [];
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        objj_msgSend(_resizeIndicator, "setFrameSize:", CGSizeMakeCopy(objj_msgSend(_CPWindowViewResizeIndicatorImage, "size")));
...
{ with(self)
{
    ...
    if (!objj_msgSend(_resizeIndicator, "isHidden"))
    {
...
instance_methods[8] = new objj_method(sel_registerName("setTitle:"), function $_CPWindowView__setTitle_(self, _cmd, title)
{ with(self)
{
    _title = title;
}
});
instance_methods[9] = new objj_method(sel_registerName("title"), function $_CPWindowView__title(self, _cmd)
{ with(self)
{
    return _title;
}
});
instance_methods[10] = new objj_method(sel_registerName("windowDidChangeDocumentEdited"), function $_CPWindowView__windowDidChangeDocumentEdited(self, _cmd)
{ with(self)
{}
});
instance_methods[11] = new objj_method(sel_registerName("windowDidChangeDocumentSaving"), function $_CPWindowView__windowDidChangeDocumentSaving(self, _cmd)
{ with(self)
{}
});
class_addMethods(the_class, instance_methods);
...
p;8;AppKit.ji;9;CALayer.ji;13;CPAnimation.ji;15;CPApplication.ji;10;CPButton.ji;12;CPClipView.ji;18;CPCollectionView.ji;9;CPColor.ji;14;CPColorPanel.ji;13;CPColorWell.ji;17;CPCompatibility.ji;11;CPControl.ji;10;CPCookie.ji;12;CPDocument.ji;22;CPDocumentController.ji;9;CPEvent.ji;8;CPFont.ji;15;CPFontManager.ji;12;CPGeometry.ji;9;CPImage.ji;13;CPImageView.ji;8;CPMenu.ji;12;CPMenuItem.ji;9;CPPanel.ji;14;CPPasteboard.ji;15;CPPopUpButton.ji;21;CPProgressIndicator.ji;13;CPResponder.ji;12;CPScroller.ji;14;CPScrollView.ji;20;CPSegmentedControl.ji;10;CPShadow.ji;10;CPSlider.ji;13;CPTextField.ji;11;CPToolbar.ji;15;CPToolbarItem.ji;8;CPView.ji;10;CPWindow.ji;20;CPWindowController.jp;13;CAAnimation.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;23;CAMediaTimingFunction.jc;6297;
...
p;9;CALayer.jI;21;Foundation/CPObject.jI;23;AppKit/CABackingStore.jI;18;AppKit/CGContext.jI;19;AppKit/CGGeometry.ji;12;CGGeometry.jc;37961;
...
instance_methods[36] = new objj_method(sel_registerName("insertSublayer:after:"), function $CALayer__insertSublayer_after_(self, _cmd, aLayer, aSublayer)
{ with(self)
{
...
p;11;CGContext.ji;12;CGGeometry.ji;19;CGAffineTransform.ji;8;CGPath.jc;30691;
kCGLineCapButt = 0;
kCGLineCapRound = 1;
kCGLineCapSquare = 2;
kCGLineJoinMiter = 0;
...
p;17;CGContextCanvas.jc;11051;var CANVAS_LINECAP_TABLE = ["butt","round","square"],
    CANVAS_LINEJOIN_TABLE = ["miter","round","bevel"],
    CANVAS_COMPOSITE_TABLE = ["source-over","source-over","source-over","source-over","darker","lighter","source-over","source-over","source-over","source-over","source-over","source-over","source-over","source-over","source-over","source-over","source-over","copy","source-in","source-out","source-atop","destination-over","destination-in","destination-out","destination-atop","xor","source-over","source-over"];
CGContextSaveGState= function(aContext)
{
...
p;13;CPAnimation.jI;21;Foundation/CPObject.ji;23;CAMediaTimingFunction.jc;5545;
...
instance_methods[5] = new objj_method(sel_registerName("setFramesPerSecond:"), function $CPAnimation__setFramesPerSecond_(self, _cmd, framesPerSecond)
{ with(self)
{
...
p;15;CPApplication.jI;21;Foundation/CPBundle.ji;17;CPCompatibility.ji;9;CPEvent.ji;8;CPMenu.ji;13;CPResponder.ji;22;CPDocumentController.jc;20023;
CPApp = nil;
...
{ with(self)
{
    ...
    if (objj_msgSend(aWindow, "respondsToSelector:", anAction))
        return delegate;
...
p;7;CPCib.jI;21;Foundation/CPObject.jI;28;Foundation/CPURLConnection.jI;25;Foundation/CPURLRequest.ji;14;CPCustomView.ji;18;_CPCibObjectData.jc;2278;
...
{ with(self)
{
    var unarchiver = objj_msgSend(objj_msgSend(CPKeyedUnarchiver, "alloc"), "initForReadingWithData:", _data),
    ...
    while (count--)
    {
        ...
        if (objj_msgSend(object, "isMemberOfClass:", objj_msgSend(CPView, "class")))
            return object;
    }
}
});
...
p;17;CPCompatibility.ji;9;CPEvent.jc;3433;
...
p;11;CPControl.ji;8;CPFont.ji;10;CPShadow.ji;8;CPView.jc;13317;
...
instance_methods[19] = new objj_method(sel_registerName("setBackgroundColor:"), function $CPControl__setBackgroundColor_(self, _cmd, aColor)
{ with(self)
{
    _backgroundColors = objj_msgSend(CPDictionary, "dictionary");
...
instance_methods[20] = new objj_method(sel_registerName("setBackgroundColor:forName:"), function $CPControl__setBackgroundColor_forName_(self, _cmd, aColor, aName)
{ with(self)
{
    if (!aColor)
...
instance_methods[21] = new objj_method(sel_registerName("backgroundColorForName:"), function $CPControl__backgroundColorForName_(self, _cmd, aName)
{ with(self)
{
...
instance_methods[22] = new objj_method(sel_registerName("setBackgroundColorWithName:"), function $CPControl__setBackgroundColorWithName_(self, _cmd, aName)
{ with(self)
{
...
p;14;CPCustomView.ji;8;CPView.jc;1147;
{var the_class = objj_allocateClassPair(CPView, "CPCustomView"),
...
{
var the_class = objj_getClass("CPCustomView")
if(!the_class) objj_exception_throw(new objj_exception(OBJJClassNotFoundException, "*** Could not find definition for class \"CPCustomView\""));
var meta_class = the_class.isa;var instance_methods = [];
instance_methods[0] = new objj_method(sel_registerName("initWithCoder:"), function $CPCustomView__initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
   _className = objj_msgSend(aCoder, "decodeObjectForKey:", CPCustomViewClassNameKey);
    var theClass = CPClassFromString(_className);
    if (!theClass)
        theClass = objj_msgSend(CPView, "class");
    if (theClass == objj_msgSend(CPView, "class"))
        self = objj_msgSend(objj_msgSend(CPView, "alloc"), "initWithCoder:", aCoder);
    return self;
}
});
class_addMethods(the_class, instance_methods);
...
p;12;CPDocument.jI;21;Foundation/CPString.jI;20;Foundation/CPArray.ji;13;CPResponder.ji;20;CPWindowController.jc;17982;
CPSaveOperation = 0;
CPSaveAsOperation = 1;
CPSaveToOperation = 2;
...
instance_methods[27] = new objj_method(sel_registerName("setHashUndoManager:"), function $CPDocument__setHashUndoManager_(self, _cmd, aFlag)
{ with(self)
{
...
p;22;CPDocumentController.jI;21;Foundation/CPObject.jI;21;Foundation/CPBundle.ji;12;CPDocument.jc;7302;
...
instance_methods[13] = new objj_method(sel_registerName("_infoForType:"), function $CPDocumentController___infoForType_(self, _cmd, aType)
{ with(self)
{
    var i = 0,
...
instance_methods[14] = new objj_method(sel_registerName("documentClassForType:"), function $CPDocumentController__documentClassForType_(self, _cmd, aType)
{ with(self)
{
...
p;20;CPDOMDisplayServer.jI;22;Foundation/CPRunLoop.jc;4832;
...
try{
        switch (instruction)
        {
            ...
            case 4: var element = CPDOMDisplayServerInstructions[index],
                                        ...
                                        break;
            case 5: CPDOMDisplayServerInstructions[index].appendChild(CPDOMDisplayServerInstructions[index+1]);
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        break;
            case 6: CPDOMDisplayServerInstructions[index].insertBefore(CPDOMDisplayServerInstructions[index+1], CPDOMDisplayServerInstructions[index+2]);
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        break;
            case 7: CPDOMDisplayServerInstructions[index].removeChild(CPDOMDisplayServerInstructions[index+1]);
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        CPDOMDisplayServerInstructions[index++] = nil;
                                        break;
...
p;19;CPDOMWindowBridge.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.ji;9;CPEvent.ji;17;CPCompatibility.ji;18;CPDOMWindowLayer.jc;29061;
...
var meta_class = the_class.isa;var instance_methods = [];
instance_methods[0] = new objj_method(sel_registerName("_bridgeMouseEvent:"), function $CPDOMWindowBridge___bridgeMouseEvent_(self, _cmd, aDOMEvent)
{ with(self)
{
...
instance_methods[1] = new objj_method(sel_registerName("_bridgeKeyEvent:"), function $CPDOMWindowBridge___bridgeKeyEvent_(self, _cmd, aDOMEvent)
{ with(self)
{
    try
    {
...
instance_methods[2] = new objj_method(sel_registerName("_bridgeScrollEvent:"), function $CPDOMWindowBridge___bridgeScrollEvent_(self, _cmd, aDOMEvent)
{ with(self)
{
    if(!aDOMEvent)
...
instance_methods[3] = new objj_method(sel_registerName("_bridgeResizeEvent:"), function $CPDOMWindowBridge___bridgeResizeEvent_(self, _cmd, aDOMEvent)
{ with(self)
{
    try
    {
...
instance_methods[4] = new objj_method(sel_registerName("_checkPasteboardElement"), function $CPDOMWindowBridge___checkPasteboardElement(self, _cmd)
{ with(self)
{
    try
    {
...
instance_methods[5] = new objj_method(sel_registerName("_clearPasteboardElement"), function $CPDOMWindowBridge___clearPasteboardElement(self, _cmd)
{ with(self)
{
    _DOMPasteboardElement.value = "";
    _DOMPasteboardElement.blur();
...
{ with(self)
{
    ...
    CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 7; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = aWindow._DOMElement;;
...
{ with(self)
{
    ...
    if (!isVisible)
    {
        if (aWindow._DOMElement.CPDOMDisplayContext) aWindow._DOMElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 5; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = aWindow._DOMElement;;
...
p;9;CPImage.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;21;Foundation/CPBundle.jI;22;Foundation/CPRunLoop.ji;12;CPGeometry.jc;11725;
...
p;13;CPImageView.ji;9;CPImage.ji;11;CPControl.ji;14;CPShadowView.jc;9957;
CPScaleProportionally = 0;
CPScaleToFit = 1;
CPScaleNone = 2;
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        _DOMImageElement.style.left = "0px";
        _DOMImageElement.style.top = "0px";
        if (_DOMImageElement.CPDOMDisplayContext) _DOMImageElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 5; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMImageElement;;
...
instance_methods[3] = new objj_method(sel_registerName("setHasShadow:"), function $CPImageView__setHasShadow_(self, _cmd, shouldHaveShadow)
{ with(self)
{
...
instance_methods[4] = new objj_method(sel_registerName("setImageScaling:"), function $CPImageView__setImageScaling_(self, _cmd, anImageScaling)
{ with(self)
{
    if (_imageScaling == anImageScaling)
        return;
...
instance_methods[5] = new objj_method(sel_registerName("imageScaling"), function $CPImageView__imageScaling(self, _cmd)
{ with(self)
{
    return _imageScaling;
}
});
instance_methods[6] = new objj_method(sel_registerName("setFrameSize:"), function $CPImageView__setFrameSize_(self, _cmd, aSize)
{ with(self)
{
    objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPControl") }, "setFrameSize:", aSize);
    objj_msgSend(self, "tile");
...
instance_methods[7] = new objj_method(sel_registerName("hideOrDisplayContents"), function $CPImageView__hideOrDisplayContents(self, _cmd)
{ with(self)
{
    if (!_image)
    {
...
instance_methods[8] = new objj_method(sel_registerName("imageRect"), function $CPImageView__imageRect(self, _cmd)
{ with(self)
{
    return _imageRect;
}
});
instance_methods[9] = new objj_method(sel_registerName("tile"), function $CPImageView__tile(self, _cmd)
{ with(self)
{
    if (!_image)
        return;
...
p;8;CPMenu.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;22;_CPImageAndTitleView.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;56972;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_menu"), new objj_ivar("_highlightView"), new objj_ivar("_trackingMenuItem"), new objj_ivar("_iconImageView"), new objj_ivar("_titleField")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
var class_methods = [];
...
instance_methods[6] = new objj_method(sel_registerName("frameForMenuItem:"), function $_CPMenuBarWindow__frameForMenuItem_(self, _cmd, aMenuItem)
{ with(self)
{
...
instance_methods[7] = new objj_method(sel_registerName("menuItemAtPoint:"), function $_CPMenuBarWindow__menuItemAtPoint_(self, _cmd, aPoint)
{ with(self)
{
    var items = objj_msgSend(_menu, "itemArray"),
        count = items.length;
...
instance_methods[8] = new objj_method(sel_registerName("mouseDown:"), function $_CPMenuBarWindow__mouseDown_(self, _cmd, anEvent)
{ with(self)
{
...
instance_methods[9] = new objj_method(sel_registerName("trackEvent:"), function $_CPMenuBarWindow__trackEvent_(self, _cmd, anEvent)
{ with(self)
{
    var type = objj_msgSend(anEvent, "type");
    if (type == CPPeriodic)
...
instance_methods[10] = new objj_method(sel_registerName("showMenu:"), function $_CPMenuBarWindow__showMenu_(self, _cmd, anEvent)
{ with(self)
{
    objj_msgSend(CPEvent, "stopPeriodicEvents");
    var frame = objj_msgSend(self, "frameForMenuItem:", _trackingMenuItem),
...
instance_methods[11] = new objj_method(sel_registerName("menuDidEndTracking:"), function $_CPMenuBarWindow__menuDidEndTracking_(self, _cmd, aNotification)
{ with(self)
{
...
instance_methods[12] = new objj_method(sel_registerName("tile"), function $_CPMenuBarWindow__tile(self, _cmd)
{ with(self)
{
    var items = objj_msgSend(_menu, "itemArray"),
        index = 0,
...
instance_methods[13] = new objj_method(sel_registerName("setFrameSize:"), function $_CPMenuBarWindow__setFrameSize_(self, _cmd, aSize)
{ with(self)
{
...
p;12;CPMenuItem.jI;20;Foundation/CPCoder.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;16;AppKit/CPImage.jI;15;AppKit/CPMenu.jI;15;AppKit/CPView.jc;28306;
...
p;13;CPResponder.jI;21;Foundation/CPObject.jc;7670;
CPDeleteKeyCode = 8;
...
p;12;CPScroller.ji;11;CPControl.jc;28156;
CPScrollerNoPart = 0;
...
instance_methods[8] = new objj_method(sel_registerName("checkSpaceForUsableParts"), function $CPScroller__checkSpaceForUsableParts(self, _cmd)
{ with(self)
{
    var bounds = objj_msgSend(self, "bounds");
...
p;20;CPSegmentedControl.jI;20;Foundation/CPArray.ji;11;CPControl.jc;17183;
...
instance_methods[24] = new objj_method(sel_registerName("drawSegmentBezel:highlgiht:"), function $CPSegmentedControl__drawSegmentBezel_highlgiht_(self, _cmd, aSegment, shouldHighlight)
{ with(self)
{}
});
...
p;10;CPSlider.ji;11;CPControl.jc;15754;
...
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
var class_methods = [];
class_methods[0] = new objj_method(sel_registerName("initialize"), function $CPHUDSlider__initialize(self, _cmd)
{ with(self)
{
...
var instance_methods = [];
instance_methods[0] = new objj_method(sel_registerName("leftTrackImage"), function $CPHUDSlider__leftTrackImage(self, _cmd)
{ with(self)
{
    return CPHUDSliderHorizontalBarLeftImage;
}
});
instance_methods[1] = new objj_method(sel_registerName("rightTrackImage"), function $CPHUDSlider__rightTrackImage(self, _cmd)
{ with(self)
{
    return CPHUDSliderHorizontalBarRightImage;
}
});
instance_methods[2] = new objj_method(sel_registerName("centerTrackImage"), function $CPHUDSlider__centerTrackImage(self, _cmd)
{ with(self)
{
    return CPHUDSliderHorizontalBarCenterImage
}
});
instance_methods[3] = new objj_method(sel_registerName("knobImage"), function $CPHUDSlider__knobImage(self, _cmd)
{ with(self)
{
...
p;13;CPTextField.ji;11;CPControl.ji;17;CPStringDrawing.jc;16177;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_isBordered"), new objj_ivar("_isBezeled"), new objj_ivar("_bezelStyle"), new objj_ivar("_isEditable"), new objj_ivar("_isSelectable"), new objj_ivar("_value"), new objj_ivar("_lineBreakMode"), new objj_ivar("_DOMTextElement")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
var class_methods = [];
class_methods[0] = new objj_method(sel_registerName("_inputElement"), function $CPTextField___inputElement(self, _cmd)
{ with(self)
{
...
instance_methods[19] = new objj_method(sel_registerName("setStringValue:"), function $CPTextField__setStringValue_(self, _cmd, aStringValue)
{ with(self)
{
    _value = aStringValue;
...
instance_methods[20] = new objj_method(sel_registerName("sizeToFit"), function $CPTextField__sizeToFit(self, _cmd)
{ with(self)
{
    var size = objj_msgSend(_value?_value:" ", "sizeWithFont:", objj_msgSend(self, "font"));
...
p;11;CPToolbar.jI;21;Foundation/CPObject.ji;15;CPPopUpButton.ji;15;CPToolbarItem.jc;19118;
...
p;8;CPView.jI;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;20;CPDOMDisplayServer.ji;12;CPGeometry.ji;13;CPResponder.ji;19;CPGraphicsContext.jc;66006;
CPViewNotSizable = 0;
CPViewMinXMargin = 1;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_window"), new objj_ivar("_superview"), new objj_ivar("_subviews"), new objj_ivar("_graphicsContext"), new objj_ivar("_frame"), new objj_ivar("_bounds"), new objj_ivar("_boundsTransform"), new objj_ivar("_inverseBoundsTransform"), new objj_ivar("_registeredDraggedTypes"), new objj_ivar("_isHidden"), new objj_ivar("_hitTests"), new objj_ivar("_postsFrameChangedNotifications"), new objj_ivar("_postsBoundsChangedNotifications"), new objj_ivar("_inhibitFrameAndBoundsChangedNotifications"), new objj_ivar("_displayHash"), new objj_ivar("_DOMElement"), new objj_ivar("_DOMImageParts"), new objj_ivar("_DOMImageSizes"), new objj_ivar("_backgroundType"), new objj_ivar("_DOMGraphicsElement"), new objj_ivar("_opacity"), new objj_ivar("_backgroundColor"), new objj_ivar("_autoresizesSubviews"), new objj_ivar("_autoresizingMask"), new objj_ivar("_layer"), new objj_ivar("_wantsLayer"), new objj_ivar("_isInFullScreenMode"), new objj_ivar("_fullScreenModeState")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
var class_methods = [];
...
var instance_methods = [];
instance_methods[0] = new objj_method(sel_registerName("initWithFrame:"), function $CPView__initWithFrame_(self, _cmd, aFrame)
{ with(self)
{
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPResponder") }, "init");
    if (self)
...
instance_methods[1] = new objj_method(sel_registerName("superview"), function $CPView__superview(self, _cmd)
{ with(self)
{
    return _superview;
}
});
instance_methods[2] = new objj_method(sel_registerName("subviews"), function $CPView__subviews(self, _cmd)
{ with(self)
{
    return _subviews;
}
});
instance_methods[3] = new objj_method(sel_registerName("window"), function $CPView__window(self, _cmd)
{ with(self)
{
    return _window;
}
});
instance_methods[4] = new objj_method(sel_registerName("addSubview:"), function $CPView__addSubview_(self, _cmd, aSubview)
{ with(self)
{
    objj_msgSend(self, "_insertSubview:atIndex:", aSubview, CPNotFound);
}
});
instance_methods[5] = new objj_method(sel_registerName("addSubview:positioned:relativeTo:"), function $CPView__addSubview_positioned_relativeTo_(self, _cmd, aSubview, anOrderingMode, anotherView)
{ with(self)
{
...
instance_methods[6] = new objj_method(sel_registerName("_insertSubview:atIndex:"), function $CPView___insertSubview_atIndex_(self, _cmd, aSubview, anIndex)
{ with(self)
{
    ...
    if (aSubview._superview == self)
    {
        ...
        CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 7; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = aSubview._DOMElement;;
        if (anIndex > index)
            --anIndex;
    }
    else
    ...
    if (anIndex == CPNotFound || anIndex >= count)
    {
        ...
        if (aSubview._DOMElement.CPDOMDisplayContext) aSubview._DOMElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 5; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = aSubview._DOMElement;;
    }
    else
    {
        _subviews.splice(anIndex, 0, aSubview);
        if (aSubview._DOMElement.CPDOMDisplayContext) aSubview._DOMElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 6; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = aSubview._DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _subviews[anIndex+1]._DOMElement;;
    }
...
instance_methods[7] = new objj_method(sel_registerName("didAddSubview:"), function $CPView__didAddSubview_(self, _cmd, aSubview)
{ with(self)
{}
});
instance_methods[8] = new objj_method(sel_registerName("removeFromSuperview"), function $CPView__removeFromSuperview(self, _cmd)
{ with(self)
{
    if (!_superview)
        return;
    ...
    objj_msgSend(objj_msgSend(_superview, "subviews"), "removeObject:", self);
        CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 7; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _superview._DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement;;
    _superview = nil;
    objj_msgSend(self, "_setWindow:", nil);
}
});
instance_methods[9] = new objj_method(sel_registerName("replaceSubview:with:"), function $CPView__replaceSubview_with_(self, _cmd, aSubview, aView)
{ with(self)
{
    if (aSubview._superview != self)
        return;
    var index = objj_msgSend(_subviews, "indexOfObjectIdenticalTo:", aSubview);
    objj_msgSend(aSubview, "removeFromSuperview");
    objj_msgSend(aView, "_insertSubview:atIndex:", aView, index);
}
});
instance_methods[10] = new objj_method(sel_registerName("_setWindow:"), function $CPView___setWindow_(self, _cmd, aWindow)
{ with(self)
{
...
instance_methods[11] = new objj_method(sel_registerName("isDescendantOf:"), function $CPView__isDescendantOf_(self, _cmd, aView)
{ with(self)
{
    var view = self;
    do
...
instance_methods[12] = new objj_method(sel_registerName("viewDidMoveToSuperview"), function $CPView__viewDidMoveToSuperview(self, _cmd)
{ with(self)
{
    if (_graphicsContext)
...
instance_methods[13] = new objj_method(sel_registerName("viewDidMoveToWindow"), function $CPView__viewDidMoveToWindow(self, _cmd)
{ with(self)
{}
});
instance_methods[14] = new objj_method(sel_registerName("viewWillMoveToSuperview:"), function $CPView__viewWillMoveToSuperview_(self, _cmd, aView)
{ with(self)
{}
});
instance_methods[15] = new objj_method(sel_registerName("viewWillMoveToWindow:"), function $CPView__viewWillMoveToWindow_(self, _cmd, aWindow)
{ with(self)
{}
});
instance_methods[16] = new objj_method(sel_registerName("willRemoveSubview:"), function $CPView__willRemoveSubview_(self, _cmd, aView)
{ with(self)
{}
});
instance_methods[17] = new objj_method(sel_registerName("enclosingMenuItem"), function $CPView__enclosingMenuItem(self, _cmd)
{ with(self)
{
    var view = self;
...
instance_methods[18] = new objj_method(sel_registerName("isFlipped"), function $CPView__isFlipped(self, _cmd)
{ with(self)
{
    return YES;
}
});
instance_methods[19] = new objj_method(sel_registerName("setFrame:"), function $CPView__setFrame_(self, _cmd, aFrame)
{ with(self)
{
...
instance_methods[20] = new objj_method(sel_registerName("frame"), function $CPView__frame(self, _cmd)
{ with(self)
{
    return { origin: { x:_frame.origin.x, y:_frame.origin.y }, size: { width:_frame.size.width, height:_frame.size.height } };
}
});
instance_methods[21] = new objj_method(sel_registerName("setFrameOrigin:"), function $CPView__setFrameOrigin_(self, _cmd, aPoint)
{ with(self)
{
...
instance_methods[22] = new objj_method(sel_registerName("setFrameSize:"), function $CPView__setFrameSize_(self, _cmd, aSize)
{ with(self)
{
...
instance_methods[23] = new objj_method(sel_registerName("setBounds:"), function $CPView__setBounds_(self, _cmd, bounds)
{ with(self)
{
...
instance_methods[24] = new objj_method(sel_registerName("bounds"), function $CPView__bounds(self, _cmd)
{ with(self)
{
    return { origin: { x:_bounds.origin.x, y:_bounds.origin.y }, size: { width:_bounds.size.width, height:_bounds.size.height } };
}
});
instance_methods[25] = new objj_method(sel_registerName("setBoundsOrigin:"), function $CPView__setBoundsOrigin_(self, _cmd, aPoint)
{ with(self)
{
...
instance_methods[26] = new objj_method(sel_registerName("setBoundsSize:"), function $CPView__setBoundsSize_(self, _cmd, aSize)
{ with(self)
{
...
instance_methods[27] = new objj_method(sel_registerName("resizeWithOldSuperviewSize:"), function $CPView__resizeWithOldSuperviewSize_(self, _cmd, aSize)
{ with(self)
{
...
instance_methods[28] = new objj_method(sel_registerName("resizeSubviewsWithOldSize:"), function $CPView__resizeSubviewsWithOldSize_(self, _cmd, aSize)
{ with(self)
{
    var count = _subviews.length;
    while (count--)
...
instance_methods[29] = new objj_method(sel_registerName("setAutoresizesSubviews:"), function $CPView__setAutoresizesSubviews_(self, _cmd, aFlag)
{ with(self)
{
    _autoresizesSubviews = aFlag;
}
});
instance_methods[30] = new objj_method(sel_registerName("autoresizesSubviews"), function $CPView__autoresizesSubviews(self, _cmd)
{ with(self)
{
    return _autoresizesSubviews;
}
});
instance_methods[31] = new objj_method(sel_registerName("setAutoresizingMask:"), function $CPView__setAutoresizingMask_(self, _cmd, aMask)
{ with(self)
{
    _autoresizingMask = aMask;
}
});
instance_methods[32] = new objj_method(sel_registerName("autoresizingMask"), function $CPView__autoresizingMask(self, _cmd)
{ with(self)
{
    return _autoresizingMask;
}
});
instance_methods[33] = new objj_method(sel_registerName("enterFullScreenMode:withOptions:"), function $CPView__enterFullScreenMode_withOptions_(self, _cmd, aScreen, options)
{ with(self)
{
...
instance_methods[34] = new objj_method(sel_registerName("exitFullScreenModeWithOptions:"), function $CPView__exitFullScreenModeWithOptions_(self, _cmd, options)
{ with(self)
{
...
instance_methods[35] = new objj_method(sel_registerName("isInFullScreenMode"), function $CPView__isInFullScreenMode(self, _cmd)
{ with(self)
{
    return _isInFullScreenMode;
}
});
instance_methods[36] = new objj_method(sel_registerName("setHidden:"), function $CPView__setHidden_(self, _cmd, aFlag)
{ with(self)
{
    if(_isHidden == aFlag)
        return;
...
instance_methods[37] = new objj_method(sel_registerName("isHidden"), function $CPView__isHidden(self, _cmd)
{ with(self)
{
    return _isHidden;
}
});
instance_methods[38] = new objj_method(sel_registerName("setAlphaValue:"), function $CPView__setAlphaValue_(self, _cmd, anAlphaValue)
{ with(self)
{
...
instance_methods[39] = new objj_method(sel_registerName("alphaValue"), function $CPView__alphaValue(self, _cmd)
{ with(self)
{
    return _opacity;
}
});
instance_methods[40] = new objj_method(sel_registerName("setOpacity:"), function $CPView__setOpacity_(self, _cmd, anOpacity)
{ with(self)
{
    objj_msgSend(self, "setAlphaValue:", anOpacity);
}
});
instance_methods[41] = new objj_method(sel_registerName("opacity"), function $CPView__opacity(self, _cmd)
{ with(self)
{
    return _opacity;
}
...
instance_methods[67] = new objj_method(sel_registerName("lockFocus"), function $CPView__lockFocus(self, _cmd)
{ with(self)
{
    if (!_graphicsContext)
    {
...
instance_methods[68] = new objj_method(sel_registerName("unlockFocus"), function $CPView__unlockFocus(self, _cmd)
{ with(self)
{
...
instance_methods[69] = new objj_method(sel_registerName("setNeedsDisplay:"), function $CPView__setNeedsDisplay_(self, _cmd, aFlag)
{ with(self)
{
    if (aFlag)
        objj_msgSend(self, "display");
...
instance_methods[70] = new objj_method(sel_registerName("setNeedsDisplayInRect:"), function $CPView__setNeedsDisplayInRect_(self, _cmd, aRect)
{ with(self)
{
    objj_msgSend(self, "displayRect:", aRect);
}
});
instance_methods[71] = new objj_method(sel_registerName("displayIfNeeded"), function $CPView__displayIfNeeded(self, _cmd)
{ with(self)
{}
});
instance_methods[72] = new objj_method(sel_registerName("display"), function $CPView__display(self, _cmd)
{ with(self)
{
...
instance_methods[74] = new objj_method(sel_registerName("isOpaque"), function $CPView__isOpaque(self, _cmd)
{ with(self)
{
    return NO;
}
});
instance_methods[75] = new objj_method(sel_registerName("visibleRect"), function $CPView__visibleRect(self, _cmd)
{ with(self)
{
    if (!_superview)
        return _bounds;
...
instance_methods[76] = new objj_method(sel_registerName("_enclosingClipView"), function $CPView___enclosingClipView(self, _cmd)
{ with(self)
{
...
instance_methods[77] = new objj_method(sel_registerName("scrollPoint:"), function $CPView__scrollPoint_(self, _cmd, aPoint)
{ with(self)
{
...
instance_methods[78] = new objj_method(sel_registerName("scrollRectToVisible:"), function $CPView__scrollRectToVisible_(self, _cmd, aRect)
{ with(self)
{
...
instance_methods[79] = new objj_method(sel_registerName("autoscroll:"), function $CPView__autoscroll_(self, _cmd, anEvent)
{ with(self)
{
    return NO;
}
});
instance_methods[80] = new objj_method(sel_registerName("adjustScroll:"), function $CPView__adjustScroll_(self, _cmd, proposedVisibleRect)
{ with(self)
{
    return proposedVisibleRect;
}
});
instance_methods[81] = new objj_method(sel_registerName("scrollRect:by:"), function $CPView__scrollRect_by_(self, _cmd, aRect, anAmount)
{ with(self)
{}
});
instance_methods[82] = new objj_method(sel_registerName("enclosingScrollView"), function $CPView__enclosingScrollView(self, _cmd)
{ with(self)
{
    var superview = _superview,
...
instance_methods[83] = new objj_method(sel_registerName("scrollClipView:toPoint:"), function $CPView__scrollClipView_toPoint_(self, _cmd, aClipView, aPoint)
{ with(self)
{
    objj_msgSend(aClipView, "scrollToPoint:", aPoint);
}
});
instance_methods[84] = new objj_method(sel_registerName("reflectScrolledClipView:"), function $CPView__reflectScrolledClipView_(self, _cmd, aClipView)
{ with(self)
{}
});
class_addMethods(the_class, instance_methods);
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        for (; index < count; ++index)
        {
            if (_subviews[index]._DOMElement.CPDOMDisplayContext) _subviews[index]._DOMElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 5; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _subviews[index]._DOMElement;;
        }
        _displayHash = objj_msgSend(self, "hash");
...
p;10;CPWindow.jI;33;Foundation/CPNotificationCenter.jI;26;Foundation/CPUndoManager.ji;12;CGGeometry.ji;13;CPAnimation.ji;13;CPResponder.jc;49391;
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        if (_windowView._DOMElement.CPDOMDisplayContext) _windowView._DOMElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 5; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _windowView._DOMElement;;
...
instance_methods[22] = new objj_method(sel_registerName("setResizeIndicatorOffset:"), function $CPWindow__setResizeIndicatorOffset_(self, _cmd, aSize)
{ with(self)
{
...
{ with(self)
{
    ...
    if (_hasShadow)
    {
        ...
        if (_shadowView._DOMElement.CPDOMDisplayContext) _shadowView._DOMElement.CPDOMDisplayContext[0] = -1; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 6; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _shadowView._DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _windowView._DOMElement;;
    }
    else
    {
        CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = 7; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _DOMElement; CPDOMDisplayServerInstructions[CPDOMDisplayServerInstructionCount++] = _shadowView._DOMElement;;
        _shadowView = nil;
    }
}
});
